...
function Navbar() {
  ...
  return (
    <div className={styles.navbar__fixed}>
      <Link to="/" className={styles.navbar__logo__fixed}>
        <svg
          fill="currentcolor"
          style={{ display: "block", width: "102px", height: "32px" }}
        >
          <path
      ...
      <div className={styles.navSearch}>
        <div className={styles.text}>검색 시작하기</div>
      ...
      <div className={styles.navContact}>
        <Link className={styles.fixed} to="/host">호스트 되기</Link>
        <svg
        ...
        <div className={styles.contact__button}>
          ...
          <div className={styles.button__login} aria-label="메인 탐색 메뉴">
            <svg
              viewBox="0 0 32 32"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
